...
/*
 Why we make builder class as static?
 - If the class is not static, we cannot use builder class without making student object

 An inner class is used like a method
 */
// An object should be created with only valid values.